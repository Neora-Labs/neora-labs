...
export function ProcessPath() {
  ...
  return (
    <div ref={columnRef} className="relative w-full max-w-[648px]">
      <svg
      ...
      <ol className="flex flex-col" aria-label="Pasos del proceso">
        {steps.map((step, index) => {
          ...
          return (
            <li key={step.number}>
              <article
                className={cn(
                  "flex min-h-[70vh] items-center gap-5 py-8 motion-safe:transition-opacity motion-safe:duration-500",
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-base leading-6 text-text-secondary">{step.description}</p>
                  <p
                    className={cn(
