...
export const es = {
  ...
  brief: {
    intro:
      "Cuéntanos qué frena tu negocio. Entendemos el proceso actual y te indicamos el mejor siguiente paso, con plazo e inversión orientativos.",
    eyebrow: "ASESORÍA TECNOLÓGICA",
    title: "Asesor tecnológico",
    emptyHeadline: "Empecemos por el problema de negocio.",
    slotProgress: "Progreso del diagnóstico",
    ...
    visitorEmailIntro:
      "Gracias por la conversación. Abajo tienes la recomendación orientativa, con plazo e inversión. Confirmamos los detalles tras revisar el contexto.",
    mailtoSubject: "Recomendación Neora Labs — {email}",
    emailSubject: "Recomendación tecnológica — {email}",
    invalidJson: "JSON inválido.",
    invalidPayload: "Payload inválido.",
